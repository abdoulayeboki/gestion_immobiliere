...
urlpatterns = [
    ...
    path('appartements/<int:pk>/', AppartementOne.as_view(), name='appartement_detail'),
    path('maisons/<int:pk>/', MaisonOne.as_view(), name='maison_detail'),
    path('proprietaires/<int:pk>/', ProprietaireOne.as_view(), name='proprietaire_detail'),
    path('immeubles/<int:pk>/', ImmeubleOne.as_view(), name='immeuble_detail'),
